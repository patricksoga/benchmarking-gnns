...
#python3 configure_tests.py --config ../configs/SBMs_node_clustering_GraphTransformer_CLUSTER_500k.json --job_note b32-bnorm-alt-ngape6-2-trials --param_values 2 --batch_size 32 --rand_pos_enc True --batch_norm True --layer_norm False --n_gape 3 --seed_array 41 95 22 35
