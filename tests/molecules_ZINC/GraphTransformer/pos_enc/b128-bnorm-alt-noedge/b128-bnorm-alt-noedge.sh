...
#python3 configure_tests.py --config ../configs/molecules_graph_regression_GraphTransformer_ZINC_500k.json --batch_size 128 --job_note b128-bnorm-alt-noedge --batch_norm True --layer_norm False --rand_pos_enc False --param_values 4 8 16 32 --edge_feat False --init_lr 0.0007 --save_name b128-bnorm-alt-noedge --pos_enc True
