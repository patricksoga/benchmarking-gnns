...
#python3 configure_tests.py --config ../configs/molecules_graph_regression_GraphTransformer_ZINC_500k.json --batch_size 128 --job_note b128-bnorm-1e-3 --batch_norm True --layer_norm False --rand_pos_enc True --param_values 8 16 18 20 64 --edge_feat True --init_lr 0.001 --matrix_type A --L 6 --hidden_dim 80 --out_dim 80 --save_name b128-bnorm-1e-3
