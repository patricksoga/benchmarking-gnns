#!/bin/bash
#$ -N SAGraphTransformer_ZINC_b32-noedge-fg-trials
#$ -q gpu
#$ -l gpu_card=1
#$ -t 1-1:1
...
python3 main_molecules_graph_regression.py --config tests/test-configs/SAGraphTransformer_molecules_ZINC_b32-noedge-fg-trials.json --job_num ${SGE_TASK_ID} --pos_enc_dim ${pos_enc_dim[${SGE_TASK_ID}]} --log_file $fname
...
#                 'spectral_attn': False,
#                 'wl_pos_enc': False},
#  'out_dir': 'out/molecules_graph_regression_b32-noedge-fg-trials',
