...
#python3 configure_tests.py --config test-configs/GatedGCN_molecules_b128_edge_feat_d128.json --rand_pos_enc True --job_note b128 --param_values 8 16 32 64 --pos_enc False
