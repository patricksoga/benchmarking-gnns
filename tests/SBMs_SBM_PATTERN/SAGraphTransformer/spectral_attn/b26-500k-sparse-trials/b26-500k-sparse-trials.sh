...
#python3 configure_tests.py --config ../configs/SBMs_node_clustering_SAGraphTransformer_PATTERN_500k.json --job_note b26-500k-sparse-trials --spectral_attn True --pos_enc False --rand_pos_enc False --param_values 10 --full_graph True --L 4 --full_graph False --batch_size 26 --lpe_dim 16 --seed_array 41 95 22 35
