...
#python3 configure_tests.py --config ../configs/SBMs_node_clustering_GraphTransformer_PATTERN_500k.json --job_note b26-lnorm-alt-R --param_values 2 4 8 32 64 --batch_size 26 --rand_pos_enc True --batch_norm False --layer_norm True --matrix_type R
