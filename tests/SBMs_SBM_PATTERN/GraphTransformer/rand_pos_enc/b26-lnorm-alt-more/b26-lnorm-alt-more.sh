...
#python3 configure_tests.py --config ../configs/SBMs_node_clustering_GraphTransformer_PATTERN_500k.json --job_note b26-lnorm-alt-more --param_values 5 6 7 10 11 12 13 14 5 --batch_size 26 --rand_pos_enc True --batch_norm False --layer_norm True
