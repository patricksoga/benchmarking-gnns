#!/bin/bash
#$ -N GraphTransformer_SBM_PATTERN_b26-500k-trials
#$ -q gpu
#$ -l gpu_card=1
#$ -t 1-1:1
...
python3 main_SBMs_node_classification.py --config tests/test-configs/GraphTransformer_SBMs_SBM_PATTERN_b26-500k-trials.json --job_num ${SGE_TASK_ID} --pos_enc_dim ${pos_enc_dim[${SGE_TASK_ID}]} --log_file $fname
