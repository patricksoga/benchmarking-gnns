#!/bin/bash
#$ -N GraphTransformer_OGB_gt_ogb_b1024-prwpe-20-noedge
#$ -q gpu
#$ -l gpu_card=1
#$ -t 1-1:1

pos_enc_dim=(0 20)
fname=$(pwd)/gt_ogb_b1024-prwpe-20-noedge_${SGE_TASK_ID}_${pos_enc_dim[${SGE_TASK_ID}]}_DEBUG.log
touch $fname
fsync -d 10 $fname &
...
python3 main_OGB_graph_regression.py --config tests/test-configs/GraphTransformer_OGB_OGB_gt_ogb_b1024-prwpe-20-noedge.json --job_num ${SGE_TASK_ID} --pos_enc_dim ${pos_enc_dim[${SGE_TASK_ID}]} --log_file $fname
...
#                 'spectral_attn': False,
#                 'wl_pos_enc': False},
#  'out_dir': 'out/OGB_graph_regression_gt_ogb_b1024-prwpe-20-noedge',
