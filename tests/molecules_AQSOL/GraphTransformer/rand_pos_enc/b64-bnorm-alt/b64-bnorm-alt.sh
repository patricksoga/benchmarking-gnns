...
#python3 configure_tests.py --config ../configs/molecules_graph_regression_GraphTransformer_AQSOL_500k.json --batch_size 64 --job_note b64-bnorm-alt --batch_norm True --layer_norm False --rand_pos_enc True --param_values 4 8 16 32 64
