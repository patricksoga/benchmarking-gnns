...
#python3 configure_tests.py --config ../configs/molecules_graph_regression_GraphTransformer_AQSOL_500k.json --batch_size 64 --job_note b64-bnorm-alt --batch_norm False --layer_norm True --rand_pos_enc False --pos_enc True --param_values 8 10 12
