...
#python3 configure_tests.py --config test-configs/GraphTransformer_CSL_rand_enc_b5.json --rand_pos_enc False --pos_enc True --pos_enc_dim 20 --rand_pos_enc False --param_values 32 --job_note b5-300k-trials --seed_array 41 95 22 35
