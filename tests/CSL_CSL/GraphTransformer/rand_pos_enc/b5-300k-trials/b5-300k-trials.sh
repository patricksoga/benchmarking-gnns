...
#python3 configure_tests.py --config test-configs/GraphTransformer_CSL_rand_enc_b5.json --rand_pos_enc False --rand_pos_enc True --matrix_type RWK --param_values 32 --job_note b5-300k-trials --seed_array 41 95 22 35
