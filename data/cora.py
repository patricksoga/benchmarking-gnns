...
class CoraDataset(Dataset):
    def __init__(self, name):
        ...
        self.name = name
        self.graph = dgl.data.CoraGraphDataset(reverse_edge=False, force_reload=True)[0]

        masks = torch.load('./data/cora/split_masks.pt')
        ...
        self.n_features = self.graph.ndata['feat'].shape[1]
