...
"""
from nets.K3Colorable_graph_classification.load_net import gnn_model # import all GNNS
...
def train_val_pipeline(MODEL_NAME, dataset, params, net_params, dirs):
    ...
    from train.train_K3Colorable_graph_classification import train_epoch_sparse as train_epoch, evaluate_network_sparse as evaluate_network
...
def main():    
    ...
    # except KeyError:
    #     out_dir = out_dir + '_sampLaplacian les_' + DATASET_NAME + '/'
